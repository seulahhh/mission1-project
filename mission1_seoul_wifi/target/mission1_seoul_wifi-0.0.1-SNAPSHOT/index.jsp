...
<div class="container menu_container">
    ...
    <div class="location_menu">
        <form>
            ...
            <button type="button" name="getApiData" onclick="getLocation()">내 위치 가져오기</button>
        </form>
    </div>
...
<%--        </tbdoy>--%>
        ...
        <%
            ...
            if (request.getParameter("lat") != null && request.getParameter("lnt") != null) {
                ...
                ApiService apiService = new ApiService();
                try {
                    sql = " select * from \"seoul-wifi-data\" order by pow(wifi_lat -" + myLocation[0] + ", 2) + pow(wifi_lat -" + myLocation[1] + ", 2) limit 20;";
        ...
        %>
        <tr>
            <td><%=apiService.getDistance(myLocation[0], rs.getDouble("wifi_lat"), myLocation[1], rs.getDouble("wifi_lnt"))%></td>
